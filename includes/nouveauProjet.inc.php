...
<form action="index.php?page=nouveauProjet" method="post">
    ...
    <input type="text" name="role" id="role" value="<?php if (!empty($_POST['role'])) {echo $_POST['role'];} ?>">
    ...
    <input type="text" name="url_figma" id="url_figma" value="<?php if (!empty($_POST['url_figma'])) {echo $_POST['url_figma'];} ?>">
    <span class="error"><?php if (!empty($errors['url_figma'])) {echo $errors['url_figma'];} ?></span>

    <label for="url_github">Lien de Gituhub</label>
    <input type="text" name="url_github" id="url_github" value="<?php if (!empty($_POST['url_github'])) {echo $_POST['url_github'];} ?>">
    <span class="error"><?php if (!empty($errors['url_github'])) {echo $errors['url_github'];} ?></span>

    <label for="url_site">Lien du site</label>
    <input type="text" name="url_site" id="auteur" value="<?php if (!empty($_POST['url_site'])) {echo $_POST['url_site'];} ?>">
    <span class="error"><?php if (!empty($errors['url_site'])) {echo $errors['url_site'];} ?></span>

    <label for="image">Image</label>
    <input type="file" name="image" id="image" value="<?php if (!empty($_POST['image'])) {echo $_POST['image'];} ?>">
